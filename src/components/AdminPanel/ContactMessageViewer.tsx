            ...
            >
                <div className="w-full flex flex-row justify-between gap-2">
                    ...
                    <div className="flex flex-col gap-2 w-full">
                        ...
                        <div className="w-full bg-gray-800 px-2 py-2 rounded text-sm">
                            <Link href={`mailto:${contactMessage.email}`} target="_blank" rel="noopener noreferrer">
                ...
                <div>
                    ...
                    <pre className="w-full mt-1 bg-gray-800 px-2 py-2 rounded text-sm outline-none">
