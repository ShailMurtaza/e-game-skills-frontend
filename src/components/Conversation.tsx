            ...
            {receiver === null && (
                <div className="absolute bottom-0 w-full bg-zinc-900 p-4 flex items-center z-0">
                    <input
                        ...
                        className="flex-1 px-4 py-2 rounded-xl outline-none bg-white text-black border border-zinc-700 placeholder-zinc-400 focus:ring-5 focus:ring-zinc-600 focus:border-transparent disabled:cursor-not-allowed disabled:opacity-40"
                        value={msg}
                    ...
                    />
                    <button
                        className="ml-3  bg-blue-900  px-4 py-2  disabled:cursor-not-allowed disabled:opacity-40"
                        onClick={() => {
                            handleSendMsg();
                        }}
                        disabled={conversation.banned}
