            ...
            <section className="px-96 py-20">
                <div className="py-5">
                    ...
                    <div>
                        ...
                        spent countless hours playing competitive games like
                        Valorant and Dota 2, we understand how hard it can be
                ...
                <div className="py-5">
                    ...
                    <div>
                        ...
                        <ul className="list-disc mx-10">
                            <li>
                                Teams discover players based on in-game skills,
                                ranks, and performance metrics.
                            </li>
                            <li>
                                Players gain visibility and get discovered by
                                organizations seeking new talent.
                            </li>
                        </ul>
